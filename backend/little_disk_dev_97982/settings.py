"""
Django settings for little_disk_dev_97982 project.
...
ROOT_URLCONF = 'little_disk_dev_97982.urls'
...
WSGI_APPLICATION = 'little_disk_dev_97982.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_disk_dev_97982 API",
    "DESCRIPTION": "API documentation for little_disk_dev_97982 App",
    "VERSION": "v1",
}
